      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            Beyond my technical acumen ,my arsenal includes a comprehensive
            command of <strong> Digital Marketing </strong>Strategies,
            propelling buisnesses to new heights.
            <br />
            <br />
